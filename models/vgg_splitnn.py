...
class VGGCenterBack(nn.Module):
    def __init__(
        self, vgg_name, num_classes, num_channels=1, num_features=1, num_parts=1, with_center=False, load=False, freeze=False
    ):
        super().__init__()
...
def VGG19CenterBack(num_channels=1, num_features=1, num_parts=1, load=False, freeze=False):
    return VGGCenterBack(
        "VGG19",
        num_classes=10,
        num_channels=num_channels,
        num_features=num_features,
